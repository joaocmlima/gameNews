...
const helpers = require('./helpers-600d94b2.js');
const index$1 = require('./index-6476ce7f.js');
  ...
  componentDidLoad() {
    {
      rIC(() => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./tap-click-4c33cd8b.js'); }).then(module => module.startTapClick(ionicGlobal.config));
        }
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          Promise.resolve().then(function () { return require('./input-shims-cb1c7b3b.js'); }).then(module => module.startInputShims(ionicGlobal.config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-83e355cb.js'); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
