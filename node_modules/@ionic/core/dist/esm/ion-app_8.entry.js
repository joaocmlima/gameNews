...
import { h as clamp } from './helpers-fde0057c.js';
import { t as transition } from './index-4e81e1e8.js';
  ...
  componentDidLoad() {
    {
      rIC(() => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-b009fc27.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-b46a1b02.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-05babe9d.js').then(module => module.startInputShims(config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await import('./swipe-back-271cf974.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
