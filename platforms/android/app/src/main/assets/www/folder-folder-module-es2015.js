...
let FolderPage = class FolderPage {
    constructor(geolocation, activatedRoute) {
    ...
    coordinates() {
        this.geolocation.getCurrentPosition().then((resp) => {
            this.map = new leaflet__WEBPACK_IMPORTED_MODULE_4__["Map"]("mapId").setView([resp.coords.latitude, resp.coords.longitude], 13);
